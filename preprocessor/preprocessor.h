...
/**
 * Different types of lines in the as file.
 */
enum line_type
{
    blank,          /**< Blank line. */
    comment,        /**< Comment line. */
    macro_def,      /**< Macro definition line. E.G "mcro m1". */
 ...
 * @note The function uses the remove_white_spaces() from utils, and assumes the macro name is started in index 4 (after the "mcro" string)
 */
