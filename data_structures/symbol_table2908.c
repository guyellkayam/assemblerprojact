    ...
    while (temp != NULL)
    {
            ...
            temp->symbol_opt == symbol_local_code)
        {
            ...
            if (existing_entry != NULL)
            {
                ...
                existing_entry->symbol_opt = (temp->symbol_opt == symbol_local_data) ? symbol_entry_data : 
                                             (temp->symbol_opt == symbol_local_code) ? symbol_entry_code : 
                                             symbol_entry_def;
            }
            else if (temp->symbol_opt == symbol_entry_def)
            {
